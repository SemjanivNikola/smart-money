...
export default function TransactionDetailsPage() {
  return (
    <PageScreen title="Transaction details">
      <div className="f gap-m">
        <div className="card px-m py-m" style={{ flexGrow: 1 }}>
          <div className="f a-c j-sb gap-m py-m" style={{ borderBottom: "1px solid var(--gray)" }}>
            <div>01.05.2024</div>
            <div style={{ fontSize: "var(--font-s)", fontStyle: "italic" }}>
              TOTAL <span style={{ display: "inline-block", fontSize: "var(--font-lg)", fontWeight: 500 }}>12,78$</span>
            </div>
          ...
          <div className="py-m">
            <span style={{ fontSize: "var(--font-s)", fontStyle: "italic" }}>NOTE</span>
            <span className="mb-m" style={{ fontSize: "var(--font-x/s)" }}>
              *Types with 0 amount are hidden
            </span>
