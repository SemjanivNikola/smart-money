...
const TextInputWithDetail = forwardRef<HTMLInputElement | null, SimpleInputProps>(function TextInput(
  ...
  return (
    <div className={s.inputWrapper} data-error={!!error}>
      ...
      <div className={s.inputContainerCol}>
...
export default TextInputWithDetail;
